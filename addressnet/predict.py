...
def predict(address: List[str], model_dir: str = None) -> List[Dict[str, str]]:
    ...
    if model_dir is None:
        ...
        # print(__file__,os.path.abspath(__file__),os.path.dirname(__file__))
        # C:\Users\guy\Desktop\address-net\address-net\addressnet\predict.py
        # C:\Users\guy\Desktop\address-net\address-net\addressnet\predict.py
        # C:\Users\guy\Desktop\address-net\address-net\addressnet
        # model_dir = "./addressnet/pretrained"
        # model_dir = "c:\\addressnet\\pretrained"
